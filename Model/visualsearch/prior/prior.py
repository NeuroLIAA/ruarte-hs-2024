...
def load(image, image_name, image_size, prior_name, prior_dir,target_object_class,image_path):
    ...
    if prior_name == 'noisy':
        ...
        prior = np.ones(shape=image_size)    
    elif prior_name == 'deepgaze':
        ...
        raise Exception("Invalid prior selected.")
